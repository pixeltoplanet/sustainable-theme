...
<p class="has-text-align-left has-text-color has-link-color has-work-sans-regular-font-family" style="color:#03081e;font-size:1rem;text-decoration:none"><?php printf( esc_html__( '%s', 'variations' ), __( '© 2026 Island. All rights reserved.', 'variations' ) ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->