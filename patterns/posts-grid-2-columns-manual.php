...
<div class="wp-block-group alignwide"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|fluid-small"}},"layout":{"type":"grid","columnCount":2,"minimumColumnWidth":"16rem"}} -->
  <div class="wp-block-group alignwide">
    <?php foreach ($projects as $project) : ?>
      ...
      <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--0);padding-right:var(--wp--preset--spacing--0);padding-bottom:var(--wp--preset--spacing--0);padding-left:var(--wp--preset--spacing--0)"><!-- wp:image {"aspectRatio":"16/9","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":{"topLeft":"var(--rounded-image)","topRight":"var(--rounded-image)","bottomLeft":"var(--rounded-image)","bottomRight":"var(--rounded-image)"}}}} -->
        <figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url($project['image']); ?>" alt="" style="border-top-left-radius:var(--rounded-image);border-top-right-radius:var(--rounded-image);border-bottom-left-radius:var(--rounded-image);border-bottom-right-radius:var(--rounded-image);aspect-ratio:16/9;object-fit:cover" /></figure>
        <!-- /wp:image -->
