 ...
 * Slug: sustainable-theme/latest-posts-grid
 * Categories: sustainable-theme,sustainable-theme/portfolio,sustainable-theme/posts
 * Description: A grid of the latest posts.
 * Keywords: posts, portfolio, blog, overview, grid
 * Inserter: true
 */
?>
<!-- wp:group {"align":"full","className":"sustainable-theme-post-grid","style":{"spacing":{"padding":{"top":"var:preset|spacing|fluid-large","bottom":"var:preset|spacing|fluid-large"},"blockGap":"var:preset|spacing|fluid-x-small"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull sustainable-theme-post-grid" style="padding-top:var(--wp--preset--spacing--fluid-large);padding-bottom:var(--wp--preset--spacing--fluid-large)"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|fluid-small","bottom":"var:preset|spacing|fluid-small"}}},"layout":{"type":"constrained"}} -->
