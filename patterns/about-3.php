...
/**
 * Title: About 3
 * Slug: sustainable-theme/about-3
 * Categories: sustainable-theme,sustainable-theme/content,sustainable-theme/new
 * Description: About section with editorial heading, two-column text, and a full-width image.
 * Keywords: about, editorial, image, story, landscape
 * Inserter: true
 */
